...
<div id="sessions-header" class="panel-heading">
	<h2 class="panel-title">
		<span class="open openclose">+</span> <a data-toggle="collapse" data-parent="#main-results" href="#sessions-result"><?php echo JText::_('COM_REDEVENT_FRONTEND_ADMIN_ALL_EVENTS'); ?>
	</h2>
</div>
