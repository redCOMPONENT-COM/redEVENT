...
<button type="button" id="reset_person" class="btn"><?php echo JText::_('COM_REDEVENT_RESET');?></button>
	...
	<li class="search-text"><?php echo JText::_('COM_REDEVENT_FRONTEND_ADMIN_SEARCH_IN'); ?></li>
	<li class="checkbox-search"><input  class="css-checkbox" name="filter_person_active" id="filter_person_active" type="checkbox" value="1"
		<?php echo $this->state->get('filter_person_active') ? ' checked="checked"' : ''; ?>/> <label class="checkbox css-label" for="filter_person_active"><?php echo JText::_('COM_REDEVENT_FRONTEND_ADMIN_ACTIVE_COURSES'); ?></label></li>
	<li class="checkbox-search"><input class="css-checkbox" name="filter_person_archive" id="filter_person_archive" type="checkbox" value="1"
		<?php echo $this->state->get('filter_person_archive') ? ' checked="checked"' : ''; ?> /> <label class="checkbox css-label" for="filter_person_archive"><?php echo JText::_('COM_REDEVENT_FRONTEND_ADMIN_COURSES_HISTORY'); ?></label></li>
</ul>
