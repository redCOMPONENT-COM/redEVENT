...
?>
<form action="<?php echo JRoute::_($this->action); ?>" method="post" id="attended-events" class="table-responsive redevent-ajaxnav">
	<div class="table-header">
		<div class="table-header-title"><?php echo JText::_('COM_REDEVENT_BOOKING_HISTORY'); ?></div>
	</div>
	...
	<?php else: ?>
	<table class="eventtable clean-table" summary="attending">
		<thead>
			<tr>
