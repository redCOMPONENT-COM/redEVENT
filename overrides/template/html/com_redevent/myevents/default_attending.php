...
?>
<form action="<?php echo JRoute::_($this->action); ?>" method="post" id="attending-events" class="table-responsive redevent-ajaxnav">
	<div class="table-header">
		<div class="table-header-title"><?php echo JText::_('COM_REDEVENT_ATTENDING'); ?></div>
	</div>
