...
<div class="container">
	...
	?>
	<!-- <div id="confirmation_message" class="row">
		<div class="col-xs-12 col-sm-8 col-sm-push-2 col-md-6 col-md-push-3">
			<div class="confirmation__container">
				<div class="confirmation__title header-title">[event_full_title]</div>
				<div class="confirmation__details">
					<div class="confirmation__user-info">
						<div class="confirmation__field-header">Du er tilmeldt med følgende oplysninger</div>
						<div class="confirmation__field-group block__field-group">
							<div class="confirmation__user-name confirmation__field block__field">
								<div class="confirmation__label">Navn</div>
								<div class="confirmation__value block__value">[field_1]</div>
							</div>
							<div class="confirmation__user-address confirmation__field block__field">
								<div class="confirmation__label">Adresse</div>
								<div class="confirmation__value block__value">[field_6]</div>
							</div>
							<div class="confirmation__user-email confirmation__field block__field">
								<div class="confirmation__label">Mail</div>
								<div class="confirmation__value block__value">[field_2]</div>
							</div>
						</div>
						<div class="confirmation__field-group block__field-group">
							<div class="confirmation__user-position confirmation__field block__field">
								<div class="confirmation__label">Stilling</div>
								<div class="confirmation__value block__value">[field_9]</div>
							</div>
							<div class="confirmation__user-hospital confirmation__field block__field">
								<div class="confirmation__label">Hospital</div>
								<div class="confirmation__value block__value">[field_3]</div>
							</div>
							<div class="confirmation__user-department confirmation__field block__field">
								<div class="confirmation__label">Afdeling</div>
								<div class="confirmation__value block__value">[field_10]</div>
							</div>
						</div>
					</div>
					<div class="horizontal-line">&nbsp;</div>
					<div class="confirmation__session-info">
						<div class="confirmation__session-descr">[aesir_session_item_short_description]</div>
						<div class="confirmation__field-group block__field-group">
							<div class="confirmation__session-date confirmation__field block__field">
								<div class="confirmation__label">Dato</div>
								<div class="confirmation__value block__value">[date format="d M, Y"] - [enddate format="d M, Y"]</div>
							</div>
							<div class="confirmation__session-location confirmation__field block__field">
								<div class="confirmation__label">Sted</div>
								<div class="confirmation__value block__value">[venue_title]</div>
							</div>
							<div class="confirmation__session-price confirmation__field block__field">
								<div class="confirmation__label">Kursusafgift</div>
								<div class="confirmation__value block__value">[priceswitch free="price_free" paid="price"]</div>
								<div class="confirmation__value block__value">[price]</div>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="confirmation__footer">
					<div class="confirmation__footer-intro">Er ovenstående forkert skal du kontakte Cardio med det samme på <a href="mailto:dcs@cardio.dk">dcs@cardio.dk</a></div>
					<div class="confirmation__btn-group"><a href="[aesir_session_item_link]&amp;Itemid=126" id="session-btn" class="btn btn-primary">SE KURSUS</a> <a href="#" id="print-btn" class="btn btn-primary">PRINT</a> <a href="index.php?option=com_redevent&amp;view=myevents&amp;Itemid=312" id="my-courses-btn" class="btn btn-primary">MIN KURSER</a></div>
				</div>
			</div>
		</div>
	</div> -->
