...
//									             .JHTML::_('link', $link, $img).'</div> ';
								$venues_html .= '<div class="courseinfo_vlink courseinfo_webform hasTooltip '.$p->alias.'"'.$title.'>'
									. $img . '<button type="button" class="btn btn-primary redeventcart-addsession" session_id="' . $event->xref . '" spg_id="' . $p->id . '">' . JText::_('ADD_TO_CART') . '</button>'
									.'</div> ';
							}
						}
						else {
//							$venues_html .= '<div class="courseinfo_vlink courseinfo_webform">'.JHTML::_('link', JRoute::_(RedeventHelperRoute::getSignupRoute('webform', $event->slug, $event->xslug)), JHTML::_('image', $imagepath.$elsettings->get('signup_webform_img', 'form_icon.gif'),  JText::_($elsettings->get('signup_webform_text')))).'</div> ';
							$venues_html .= '<div class="courseinfo_vlink courseinfo_webform">'
								. JHTML::_('image', $imagepath.$elsettings->get('signup_webform_img', 'form_icon.gif'),  JText::_($elsettings->get('signup_webform_text')))
								. '<button type="button" class="btn btn-primary redeventcart-addsession" session_id="' . $event->xref . '">' . JText::_('ADD_TO_CART') . '</button>'
								.'</div> ';
						}
						break;
					case 'formaloffer':
