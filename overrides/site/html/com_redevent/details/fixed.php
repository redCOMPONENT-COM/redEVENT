...
<?php if ($this->params->def( 'show_page_title', 1 )) : ?>
	<h1 class="componentheading">
		<?php echo $this->row->session_title; ?>
	</h1>
<?php endif; ?>
...
<!-- Details EVENT -->
    ...
    if ($lang == 'en-GB')
    {
    	echo $this->tags->ReplaceTags('[type_en]');
    }
    else
    {
	    echo $this->tags->ReplaceTags('[type_dk]');
    }
  	...
  	<dt class="when"><?php echo JText::_('COM_REDEVENT_WHEN' ); ?></dt>
		<dd class="when">
  		...
  		?>
		    ...
		    <dd class="where">
    			<?php echo $this->escape($this->row->venue); ?>
...
<!-- 		<dt class="category"><?php echo $n < 2 ? JText::_('COM_REDEVENT_CATEGORY' ) : JText::_('COM_REDEVENT_CATEGORIES' ); ?>:</dt>
			...
			<?php echo RedeventHelperOutput::mapicon($this->row, array('class' => 'event-map')); ?>
		</dl>
	</div>
  	...
  	if ($stripped) : ?>
  		...
  		<div class="description event_desc aa">
  	...
  	if ($strip_details) : ?>
  		...
  		<div class="description event_desc ss">
