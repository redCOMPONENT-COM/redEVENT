...
?>
<div id="redevent" class="el_eventlist mylistevent">
...
<?php if ($this->canAddXref): ?>
	<div class="add_new_event_session"><?php echo JHTML::link(RedeventHelperRoute::getEditXrefRoute(), JText::_('COM_REDEVENT_MYEVENTS_ADD_NEW_EVENT_SESSION')); ?></div>
<?php endif; ?>

<?php if ($this->canAddEvent): ?>
	<div class="add_new_event"><?php echo JHTML::link(RedeventHelperRoute::getEditEventRoute(), JText::_('COM_REDEVENT_MYEVENTS_ADD_NEW_EVENT')); ?></div>
<?php endif; ?>
<div class="mylistevent_venues">
