...
defined( '_JEXEC' ) or die( 'Restricted access' );
$colnames = explode(",", $this->params->get('lists_columns_names', 'date, title, venue, city, category, info'));
...
<table class="eventtable" summary="eventlist">
	...
	<thead>
		...
		<?php switch ($col):
			case 'date': ?>
			<th id="el_date" class="sectiontableheader"><?php echo JHTML::_('grid.sort', JText::_('COM_REDEVENT_DATE'), 'x.dates', $this->lists['order_Dir'], $this->lists['order'] ); ?></th>
			<?php break;?>
			...
			<?php case 'city': ?>
			<th id="el_city" class="sectiontableheader"><?php echo JHTML::_('grid.sort', JText::_('COM_REDEVENT_CITY'), 'l.city', $this->lists['order_Dir'], $this->lists['order'] ); ?></th>
			<?php break;?>

			<?php case 'country': ?>
			<?php case 'countryflag': ?>
			<th id="el_country" class="sectiontableheader"><?php echo JHTML::_('grid.sort', JText::_('COM_REDEVENT_COUNTRY'), 'l.country', $this->lists['order_Dir'], $this->lists['order'] ); ?></th>
			<?php break;?>

			<?php case 'state': ?>
			<th id="el_state" class="sectiontableheader"><?php echo JHTML::_('grid.sort', JText::_('COM_REDEVENT_STATE'), 'l.state', $this->lists['order_Dir'], $this->lists['order'] ); ?></th>
			<?php break;?>
	...
	?>
		...
		itemscope itemtype="http://schema.org/Event">
			...
			<td class="re_location" itemprop="location" itemscope itemtype="http://schema.org/Place">
			<?php
