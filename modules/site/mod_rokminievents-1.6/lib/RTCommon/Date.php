...
class RTCommon_Date
{
	...
	/**
	 * Translates meridiem abbreviation to string
	 *
	 * @access protected
	 ...
	 */
	function _meridiemToString($month, $abbr = false)
	{
		switch ($month)
		{
			case 1:  return $abbr ? JText::_('AM')     	: JText::_('');
			case 2:  return $abbr ? JText::_('am')  	: JText::_('');
			case 3:  return $abbr ? JText::_('PM')    	: JText::_('');
			case 4:  return $abbr ? JText::_('pm')     	: JText::_('');
		}
	}
	/**
