 ...
 * @since 0.9
 */
class RedEventControllerConfirmation extends RedEventController
{
	/**
	 * Constructor
	 *
	...
	function display() {
		...
		/* Standard model */
		$view->setModel( $this->getModel( 'confirmation', 'RedeventModel' ), true );
		$view->setModel( $this->getModel( 'details', 'RedeventModel' ) );
		$view->setLayout(JRequest::getVar('page'));
