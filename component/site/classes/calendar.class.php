...
// 		$out.="<a href=\"".$this->weekUrl.$glue.$this->yearID."=".$year."&amp;".$this->weekID."=".$week."\">".$week."</a>";
	...
	*/
	function getMonthName($var = false)
	{
		...
		{
			case 1:
				return JText::_($this->jan);
			case 2:
				return JText::_($this->feb);
			case 3:
				return JText::_($this->mar);
			case 4:
				return JText::_($this->apr);
			case 5:
				return JText::_($this->may);
			case 6:
				return JText::_($this->jun);
			case 7:
				return JText::_($this->jul);
			case 8:
				return JText::_($this->aug);
			case 9:
				return JText::_($this->sep);
			case 10:
				return JText::_($this->oct);
			case 11:
				return JText::_($this->nov);
			case 12:
				return JText::_($this->dec);
		}
	}
	...
	*/
	function getDayName($var = false)
	{
		...
		{
			case 0:
				return JText::_($this->sun);
			case 1:
				return JText::_($this->mon);
			case 2:
				return JText::_($this->tue);
			case 3:
				return JText::_($this->wed);
			case 4:
				return JText::_($this->thu);
			case 5:
				return JText::_($this->fri);
			case 6:
				return JText::_($this->sat);
		}
	}
