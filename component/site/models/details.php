...
class RedeventModelDetails extends JModel
{
	...
	function _loadDetails()
	{
		if (empty($this->_details))
		{
			...
			$query->select('v.venue, v.id AS venue_id, v.city, v.locimage, v.map, v.country, v.street, v.plz, v.state, v.locdescription, v.url, v.email AS venue_email, v.contactAdminEmail');
