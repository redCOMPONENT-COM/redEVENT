...
if ($this->registration) { 
	...
	<?php
	echo JHTML::_('link', JRoute::_('index.php?option=com_redevent&view=details&id='.$this->registration->eventid.'&xref='.JRequest::getInt('xref').'&id='.JRequest::getInt('id')), JText::_('RETURN_EVENT_DETAILS'));
}
else {
	echo $this->message;
}
