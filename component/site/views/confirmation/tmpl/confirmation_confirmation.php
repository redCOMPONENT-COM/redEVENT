...
<script type="text/javascript">
	window.open( window.location.protocol+"//"+window.location.host+'/index2.php?view=confirmation&page=print&submit_key=<?php echo JRequest::getVar('submit_key'); ?>&option=com_redevent' );
</script>
<?php } ?>