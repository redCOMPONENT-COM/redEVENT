...
<?php if ($this->row->datimage) :
				echo redEVENTImage::modalimage( JPATH_SITE.DS.$this->dimage, $this->row->title);
			else :
...
<small class="editlinktip hasTip"	title="<?php echo JText::_('COM_REDEVENT_NOTES' ); ?>::<?php echo JText::_('COM_REDEVENT_MAX_IMAGE_FILE_SIZE').' '.$this->elsettings->get('sizelimit').' kb'; ?>"><?php echo $this->infoimage; ?> </small>
</div>
<?php echo $pane->endPanel(); ?>
<?php endif; ?>
