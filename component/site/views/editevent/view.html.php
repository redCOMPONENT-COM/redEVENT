...
class RedeventViewEditevent extends JView
{
	...
	public function display($tpl=null)
	{
		...
		elseif ($this->getLayout() == 'eventdate')
		{
	 ...
	 * @since 0.9
	 */
	protected function _displayselectvenue($tpl)
	{
		$mainframe = JFactory::getApplication();
	...
	/**
	 * Creates the output for the session form
	 *
	 * @param   string  $tpl  tpl
	 *
	 * @return void
	 ...
	 * @since 0.9
	 */
	protected function _displayEventdate($tpl = null)
	{
		$mainframe = Jfactory::getApplication();
	 ...
	 * @param   string  $onUpdate  js code for the update action
