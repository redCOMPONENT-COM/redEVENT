...
$edit_image   = JHTML::_('image', 'media/com_redevent/images/calendar_edit.png', JText::_('COM_REDEVENT_Edit' ), 'class="hasTip" title="'.JText::_('COM_REDEVENT_Edit' ).'::"');
$remove_image = JHTML::_('image', 'media/com_redevent/images/no.png', JText::_('COM_REDEVENT_Delete' ), 'class="hasTip" title="'.JText::_('COM_REDEVENT_Delete' ).'::"');
