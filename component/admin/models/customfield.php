 ...
 * @since 0.1
 */
class RedeventModelCustomfield extends JModelAdmin
{
  /**
   * item id
   *
   ...
   * @since	1.6
   */
  public function getTable($type = 'redevent_customfield', $prefix = '', $config = array())
  {
  ...
  {
  	// Get the form.
  	$form = $this->loadForm('com_redevent.customfield', 'customfield',
  ...
  protected function loadFormData()
  {
  	...
  	$data = JFactory::getApplication()->getUserState('com_redevent.edit.customfield.data', array());
  	if (empty($data))
  	{
  		$data = $this->getData();
  	}
