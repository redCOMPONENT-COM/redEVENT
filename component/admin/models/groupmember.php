...
//			$test = $obj->checkout($uid, $this->_id);
	 ...
	 * @since	1.6
	 */
	public function getTable($type = 'redevent_groupmembers', $prefix = '', $config = array())
	{
	...
	{
		// Get the form.
		$form = $this->loadForm('com_redevent.groupmember', 'groupmember',
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_redevent.edit.groupmember.data', array());
		if (empty($data))
		{
			$data = $this->getData();
		}
