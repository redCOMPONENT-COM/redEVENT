...
/**
 * redEVENT Component Bundles Model
 *
 * @package  Redevent.admin
 * @since    3.2.0
 */
class RedeventModelBundles extends RModelList
{
	/**
	 ...
	 * @var  string
	 */
	protected $filterFormName = 'filter_bundles';
	 ...
	 * @var  string
	 */
	protected $limitField = 'bundles_limit';
