...
<form action="index.php?option=com_redevent&view=bundles" class="admin" id="adminForm" method="post" name="adminForm">
	<?php
		...
		<table class="table table-striped" id="table-items">
			...
			<tr>
				...
				<th width="30" nowrap="nowrap">
					<?php echo JHTML::_('rsearchtools.sort', 'JSTATUS', 'o.published', $listDirn, $listOrder); ?>
				</th>
				...
				<tr>
					...
					<?php if ($this->canEdit) : ?>
						<td>
							<?php if ($row->checked_out) : ?>
								...
								echo JHtml::_('rgrid.checkedout', $i, $editor->name, $row->checked_out_time, 'bundles.', $canCheckin);
								?>
							<?php endif; ?>
						</td>
					<?php endif; ?>
					<td>
						<?php if ($this->canEditState) : ?>
							<?php echo JHtml::_('rgrid.published', $row->published, $i, 'bundles.', true, 'cb'); ?>
						<?php else : ?>
					...
					<td>
						...
						<?php if (($row->checked_out) || (!$this->canEdit)) : ?>
							<?php echo $itemTitle; ?>
						<?php else : ?>
							<?php echo JHtml::_('link', 'index.php?option=com_redevent&task=bundle.edit&id=' . $row->id, $itemTitle); ?>
						<?php endif; ?>
					</td>
					<td>
