...
<?php /* TODO: to be removed ? these fields are not used any more, as there is a tag for the display now 
	...
	*/ ?>
	...
	<tr class="row<?php echo $k = 1 - $k; ?>">
		...
		<td>
      <?php echo JHTML::_('link', '#', JText::_('TAGS'), "onClick='jQuery(\"div#notify_on_list_body_tags\").toggle(\"slideUp\"); return false;'"); ?>
      <div id="notify_on_list_body_tags" style="display: none;">
