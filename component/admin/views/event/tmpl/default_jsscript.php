<script type="text/javascript" charset="utf-8">
    ...
    datetime += '<tr class="row0"><td><?php echo JText::_('DETAILS');?></td><td><?php echo JText::_('XREF WYSIWYG NOTICE'); ?></br><textarea name="'+parentid+'['+random+'][details]" cols="75" rows="10"></textarea></td></tr>';
		datetime += '</table>';
		datetime += '</div></div>';
