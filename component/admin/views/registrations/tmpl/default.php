...
<form action="index.php" method="post" name="adminForm" id="adminForm">
	...
	<?php if ($this->cancelled): ?>
		<div
			class="cancelled-notice"><?php echo($this->cancelled == 1 ? JTExt::_('COM_REDEVENT_CANCELLED_REGISTRATIONS') : JTExt::_('COM_REDEVENT_ALL_REGISTRATIONS')); ?></div>
	<?php endif; ?>
	...
	<table class="adminlist">
		...
		for ($i = 0, $n = count($this->rows); $i < $n; $i++)
		{
			...
			$link = 'index.php?option=com_redevent&view=attendee&xref=' . $row->xref . '&cid[]=' . $row->id . '&return=' . $this->returnUrl;
				...
				<td>
					...
					else
					{
						...
						<span class="editlinktip hasTip"
						      title="<?php echo JText::_('COM_REDEVENT_EDIT_REGISTRATION'); ?>::<?php echo $row->name; ?>">
