...
<ul class="nav nav-tabs" id="eventtemplateTab">
	<li class="active">
...
<div class="tab-content">
	<div class="tab-pane active" id="exporttab">
		<div class="row-fluid">
			...
			<form
				action="index.php?option=com_redevent&task=eventtemplatescsv.export&format=csv"
	...
	<div class="tab-pane" id="importtab">
		<div class="row-fluid">
			<form
				...
				<input type="hidden" name="task" value="eventtemplatescsv.import" />
				<?php echo JHtml::_('form.token'); ?>
			</form>
		</div>
	</div>
