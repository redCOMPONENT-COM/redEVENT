...
<script type="text/javascript">
	...
	submitbutton = function (pressbutton)
	{
		...
		if (pressbutton == 'eventtemplates.delete')
		{
			var r = confirm('<?php echo JText::_("COM_REDEVENT_EVENTTEMPLATES_REMOVE_CONFIRM_MESSAGE")?>');
...
<form action="index.php?option=com_redevent&view=eventtemplates" class="admin" id="adminForm" method="post" name="adminForm">
	<?php
