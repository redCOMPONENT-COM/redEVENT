...
<script type="text/javascript">
	...
	submitbutton = function (pressbutton)
	{
		...
		if (pressbutton == 'pricegroups.delete')
		{
			var r = confirm('<?php echo JText::_("COM_REDEVENT_PRICEGROUP_DELETE_COMFIRM")?>');
...
<form action="index.php?option=com_redevent&view=pricegroups" class="admin" id="adminForm" method="post" name="adminForm">
	<?php
					...
					<?php if ($this->canEdit) : ?>
						<td>
							<?php if ($row->checked_out) : ?>
								...
								echo JHtml::_('rgrid.checkedout', $i, $editor->name, $row->checked_out_time, 'pricegroups.', $canCheckin);
								?>
							<?php endif; ?>
						</td>
					<?php endif; ?>
