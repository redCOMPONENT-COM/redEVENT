...
$saveOrderUrl = 'index.php?option=com_redevent&task=venuescategories.saveOrderAjax&tmpl=component';
...
<script type="text/javascript">
	...
	submitbutton = function (pressbutton)
	{
		...
		if (pressbutton == 'venuescategories.delete')
		{
			var r = confirm('<?php echo JText::_("COM_REDEVENT_venuesCATEGORY_DELETE_COMFIRM")?>');
...
<form action="index.php?option=com_redevent&view=venuescategories" class="admin" id="adminForm" method="post" name="adminForm">
	<?php
		...
		<table class="table table-striped" id="table-items">
			...
			<tr>
				...
				<th class="title" width="auto">
					<?php echo JHTML::_('rsearchtools.sort', 'COM_REDEVENT_NAME', 'c.name', $listDirn, $listOrder); ?>
				</th>
				<th width="100">
					<?php echo JHTML::_('rsearchtools.sort', 'COM_REDEVENT_PARENT_CATEGORY', 'c.left', $listDirn, $listOrder); ?>
				</th>
				<th width="150">
					<?php echo JText::_('COM_REDEVENT_VENUES'); ?>
				</th>
				<th width="150">
				...
				<tr>
					...
					<td>
						<?php if ($this->canEditState) : ?>
							<?php echo JHtml::_('rgrid.published', $row->published, $i, 'venuescategories.', true, 'cb'); ?>
						<?php else : ?>
					...
					<?php if ($this->canEdit) : ?>
						<td>
							<?php if ($row->checked_out) : ?>
								...
								echo JHtml::_('rgrid.checkedout', $i, $editor->name, $row->checked_out_time, 'venuescategories.', $canCheckin);
								?>
							<?php endif; ?>
						</td>
					<?php endif; ?>
					...
					<td>
						...
						<?php if (($row->checked_out) || (!$this->canEdit)) : ?>
							<?php echo $itemTitle; ?>
						<?php else : ?>
							<?php echo JHtml::_('link', 'index.php?option=com_redevent&task=venuescategory.edit&id=' . $row->id, $itemTitle); ?>
						<?php endif; ?>
					</td>
					<td>
