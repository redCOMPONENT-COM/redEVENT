 ...
 * @since    3.0
 */
class RedeventControllerCategoriescsv extends RControllerForm
{
	/**
	...
	{
		$this->setRedirect('index.php?option=com_redevent&view=categoriescsv');
	}
	...
	public function import()
	{
		...
		if (!isset($jformFiles['import']))
		{
			...
			$this->redirect('index.php?options=com_redevent&view=categoriescsv', $msg, 'error');
		}
		...
		if (count($records))
		{
			$model = $this->getModel('categoriescsvimport');
		...
		$this->setRedirect('index.php?option=com_redevent&view=categoriescsv', $msg);
	}
}
