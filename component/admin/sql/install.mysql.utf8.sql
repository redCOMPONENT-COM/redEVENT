...
`contactAdminEmail` varchar(200) default NULL,
...
`b2b_attendee_notification_mailflow_orgadmin_confirmation_subject_tag` VARCHAR(30),
`b2b_attendee_notification_mailflow_orgadmin_cancellation_subject_tag` VARCHAR(30),
