...
<div id="editmember-info">
	...
	<form class="form-horizontal form-validate" id="member-update" method="post" action="index.php?option=com_redeventb2b&task=frontadmin.update_user&tmpl=component<?= $itemId ;>" enctype="multipart/form-data">
