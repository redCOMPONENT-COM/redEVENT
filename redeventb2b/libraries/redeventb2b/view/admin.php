 ...
 * @package     Redeventb2b
 * @subpackage  Library
 * @copyright   Redeventb2b (C) 2008-2015 Julien Vonthron. All rights reserved.
 ...
 * @since       3.0
 */
abstract class Redeventb2bViewAdmin extends RViewAdmin
{
	/**
	 ...
	 * @var string
	 */
	protected $componentTitle = 'redEVENT B2B';
