 ...
 * @since  1.0.0
 */
class PlgAesir_FieldRedevent_CategoryFormFieldCategory extends CustomField
{
	/**
	 * The form field type.
	 *
	...
	protected function getLayoutData()
	{
		...
		$categoriesOptions = $this->getCategoryOptions();
		$data['options'] = $categoriesOptions ? array_merge($options, $categoriesOptions) : $options;
