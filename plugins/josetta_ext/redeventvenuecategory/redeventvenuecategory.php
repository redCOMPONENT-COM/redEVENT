 ...
 * @since       2.5
 */
class plgJosetta_extRedeventVenueCategory extends JosettaClassesExtensionplugin
{
	protected $_context = 'com_redevent_venue_category';

	protected $_defaultTable = 'redevent_venues_categories';
	...
	{
		$item = array(self::_context => 'redEVENT - ' . JText::_('COM_REDEVENT_VENUES_CATEGORIES'));
		$items[] = $item;
