 ...
 *
 * @package		Josetta
 * @subpackage	josetta.redeventtextsnippet
 */
class plgJosetta_extRedeventtextsnippet extends JosettaClassesExtensionplugin
{
	protected $_context = 'com_redevent_textsnippet';
	protected $_defaultTable = 'redevent_textlibrary';
	...
	{
		$item = array( self::$this->_context => 'redEVENT - ' . JText::_('COM_REDEVENT_title_textsnippets'));
		$items[] = $item;
		return $items;
	}
	...
	protected function _getTable()
	{
		...
		$table = RTable::getAdminInstance('Textsnippet', array(), 'com_redevent');
