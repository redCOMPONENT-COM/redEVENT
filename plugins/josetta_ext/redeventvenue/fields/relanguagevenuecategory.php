 ...
 * @since       11.1
*/
class JFormFieldRELanguageVenueCategory extends JFormFieldCategory {


	public $type = 'RELanguageVenueCategory';
...
// 			echo '<pre>';print_r($this->element); echo '</pre>';exit;
		...
		if ($published) {
			$categoriesoptions = JosettaReVenueCategoryHelper::getCategoryOptionsPerLanguage( array( 'filter.published' => explode(',', $published), 'filter.languages' => explode( ',', $languages)));
		} else {
			$categoriesoptions = JosettaReVenueCategoryHelper::getCategoryOptionsPerLanguage( array( 'filter.languages' => explode( ',', $languages)));
		}
