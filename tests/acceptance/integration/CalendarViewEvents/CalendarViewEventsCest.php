...
class CalendarViewEventsCest
{
    ...
    public function __construct()
    {
        ...
        $this->eventName         = $this->faker->bothify("EventName ##??");
...
//    }
    ...
    public function createSession(SessionManagerSteps $I)
    {
        ...
        $I->createSessionForEvents($this->eventName,$this->VanueName,$this->SessionName);
        $I->waitForText(AbstractPage::$messageSaveSuccess, 30, AbstractPage::$message);
    }
    ...
    public function CheckFrontEnd(UpcomingEventsSteps $I)
    {
        ...
        $I->checkViewEventWithCalendar($this->menuItem,$this->SessionName,$this->eventName,$this->VanueName);
    }
