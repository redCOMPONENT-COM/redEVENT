...
/**
 * Class WeekViewDefaultLayoutCest
 * @since 3.2.9
 */
class WeekViewDefaultLayoutCest
{
	...
	/**
	 * WeekViewDefaultLayoutCest constructor.
	 * @since 3.2.9
	 */
	public function __construct()
	{
		...
		$this->menuItem          = 'Week view default layout';
	...
	{
		$I->wantToTest('Add session upcoming in redEVENT');
		$I->createSessionUpcomming($this->eventName, $this->venueName, $this->sessionName);
		$I->waitForText(AbstractPage::$messageSaveSuccess, 30, AbstractPage::$message);
	}
	...
	{
		$I->wantTo("Create menu item Week View Default Layout");
	 ...
	 * @since 3.2.9
	 */
	public function checkWeekViewOnFrontend(SessionManagerSteps $I)
	{
		$I->wantToTest('Check Week View on Frontend');
		$I->checkWeekView($this->menuItem, $this->eventName, $this->categoryName, $this->venueName);
	}
