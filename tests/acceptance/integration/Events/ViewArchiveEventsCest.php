...
class ViewArchiveEventsCest
{
	...
	public function createSession(SessionManagerSteps $I)
	{
		...
		$I->createSessionHaveStatus($this->eventName,$this->VanueName,$this->SessionName,$this->status);
	}
	 ...
	 * @throws Exception
	 */
	public function CheckFrontEndWithEventsArchive(UpcomingEventsSteps $I)
	{
		$I->wantToTest('Check Events archive on front-end');
		$I->checkEventArchive($this->menuItem,$this->SessionName,$this->eventName,$this->VanueName,$this->categoryName);
	}
