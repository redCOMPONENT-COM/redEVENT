...
use Step\Acceptance\Administrator\DaySteps;
...
class DayCest
{
	 ...
	 * @since 3.2.9
	 */
	public function checkFrontEndDayMissing(DaySteps $I)
	{
		$I->wantToTest('Check Day Missing on front-end');
		$I->checkDayMissing($this->menuItem);
	}
	...
	public function createSession(SessionManagerSteps $I)
	{
		...
		$I->createSessionForDay($this->eventName, $this->venueName, $this->sessionName);
		$I->waitForText(AbstractPage::$messageSaveSuccess, 30, AbstractPage::$message);
	}
	 ...
	 * @since 3.2.9
	 */
	public function checkFrontEndDay(DaySteps $I)
	{
		$I->wantToTest('Check Day on front-end');
		$I->checkDay($this->menuItem, $this->eventName, $this->venueName, $this->categoryName);
	}
